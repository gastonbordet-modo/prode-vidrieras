...
import type { MockScenario } from "@/lib/mock-ranking-data";

export function ScenarioSelector({
  scenarios,
}: {
  scenarios: Pick<MockScenario, "id" | "label" | "description">[];
}) {
  ...
  const selected = scenarios.find((s) => s.id === requested)?.id ?? scenarios[0]!.id;
